...
import { WhatsAppWorkflowVersionStepOperationsWorkspaceService } from 'src/modules/workflow/workflow-builder/workflow-version-step/whatsapp-workflow-version-step-operations.workspace-service';
...
@Module({
  ...
  providers: [
    ...
    WhatsAppWorkflowVersionStepOperationsWorkspaceService,
    {
      provide: WorkflowVersionStepOperationsWorkspaceService,
      useExisting: WhatsAppWorkflowVersionStepOperationsWorkspaceService,
    },
